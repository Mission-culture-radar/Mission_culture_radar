      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl shadow-2xl p-8 border border-purple-500/20">
          {content ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-400">Chargement de la politique de confidentialité...</p>
            </div>
          )}
        </div>
        ...
        <div className="text-center mt-8">
          ...
          <p className="text-gray-500 text-xs mt-2">
            Cette politique de confidentialité s'applique à l'ensemble du site Culture Radar
          </p>
        </div>
